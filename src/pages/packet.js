...
const PacketSniffingSimulationPage = () => {
  ...
  const handleStartSimulation = async () => {
    if (agreed) {
      ...
      try {
        await addDoc(collection(db, "Packet sniffing simulation"), {
  ...
  return (
    <div style={styles.wrapper}>
      <h2 style={styles.title}>Packet Sniffing Simulation</h2>
...
export default PacketSniffingSimulationPage;
