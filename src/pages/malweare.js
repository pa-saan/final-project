...
const MalwareSimulationPage = () => {
  ...
  const handleStartSimulation = async () => {
    if (agreed) {
      ...
      try {
        await addDoc(collection(db, "Malware simulation"), {
  ...
  return (
    <div style={styles.wrapper}>
      <h2 style={styles.title}>Malware Infection Simulation</h2>
...
export default MalwareSimulationPage;
